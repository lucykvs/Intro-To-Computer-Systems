...
struct Street {
  ...
  // uthread_sem_t west;               // to wait and signal westbound cars
...
int main (int argc, char** argv) {
  ...
  printf ("Times with 4 cars going east: %d\n", occupancyHistogram [EAST] [4]);
  printf ("Times with 5 cars going east: %d\n", occupancyHistogram [EAST] [5]);
  printf ("Times with 6 car  going east: %d\n", occupancyHistogram [EAST] [6]);
  printf ("Times with 7 cars going east: %d\n", occupancyHistogram [EAST] [7]);
  printf ("Times with 8 cars going east: %d\n", occupancyHistogram [EAST] [8]);
  printf ("Times with 9 cars going east: %d\n", occupancyHistogram [EAST] [9]);
  printf ("Times with 10 cars going east: %d\n", occupancyHistogram [EAST] [10]);
  ...
  printf ("Times with 4 cars going west: %d\n", occupancyHistogram [WEST] [4]);
  printf ("Times with 5 cars going west: %d\n", occupancyHistogram [WEST] [5]);
  printf ("Times with 6 car  going west: %d\n", occupancyHistogram [WEST] [6]);
  printf ("Times with 7 cars going west: %d\n", occupancyHistogram [WEST] [7]);
  printf ("Times with 8 cars going west: %d\n", occupancyHistogram [WEST] [8]);
  printf ("Times with 9 cars going west: %d\n", occupancyHistogram [WEST] [9]);
  printf ("Times with 10 cars going west: %d\n", occupancyHistogram [WEST] [10]);  
  
  printf("Total occupancy: %d\n", (occupancyHistogram [EAST] [1] + occupancyHistogram [EAST] [2] + occupancyHistogram [EAST] [3] + occupancyHistogram [EAST] [4] + occupancyHistogram [EAST] [5] +
                                  occupancyHistogram [WEST] [1] + occupancyHistogram [WEST] [2] + occupancyHistogram [WEST] [3] + occupancyHistogram [WEST] [4] + occupancyHistogram [WEST] [5]));
  ...
  for (int i=0; i < WAITING_HISTOGRAM_SIZE; i++)
    if (waitingHistogram [i]) {
      printf ("  Cars waited for           %4d car%s to enter: %4d time(s)\n",
        ...
        histSum += waitingHistogram[i];
    }

  printf("Total waiting histogram entries: %d\n", histSum);
