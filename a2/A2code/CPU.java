...
public class CPU extends AbstractSM213CPU {
   ...
   * register from memory into instruction register and set "pc" to point to the
   * next instruction to execute.
   *
   * Input register: pc. Output registers: pc, instruction, insOpCode, insOp0,
   * insOp1, insOp2, insOpImm, insOpExt
   * 
   * @see AbstractSM213CPU for pc, instruction, insOpCode, insOp0, insOp1, insOp2,
   *      insOpImm, insOpExt
   *
   * @throws MainMemory.InvalidAddressException when program counter contains an
  ...
  /**
   * Execution Stage of CPU Cycle. Execute instruction that was fetched by Fetch
   * stage.
   *
   * Input state: pc, instruction, insOpCode, insOp0, insOp1, insOp2, insOpImm,
   * insOpExt, reg, mem 
   ...
   *
   * @throws InvalidInstructionException                when instruction format is
   *                                                    invalid.
   * @throws MachineHaltException                       when instruction is the
   *                                                    HALT instruction.
   * @throws RegisterSet.InvalidRegisterNumberException when instruction
   *                                                    references an invalid
   *                                                    register (i.e, not 0-7).
   * @throws MainMemory.InvalidAddressException         when instruction
   *                                                    references an invalid
   *                                                    memory address.
   */
  @Override
  protected void execute() throws InvalidInstructionException, MachineHaltException,
      RegisterSet.InvalidRegisterNumberException, MainMemory.InvalidAddressException {
