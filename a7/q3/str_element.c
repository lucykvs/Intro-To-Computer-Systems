...
int str_compare(struct element *elem1, struct element *elem2) {
    ...
    struct str_element *str_elem1 = (struct str_element*) elem1;
    struct str_element *str_elem2 = (struct str_element*) elem2;
    return strcmp(str_elem1, str_elem2);
...
struct str_element_class str_element_class_obj = {
    str_print,
    str_compare,
...
int is_str_element(struct element *element) {
    return (element->class == &str_element_class_obj);
}
...
struct str_element *str_element_new(char *value) {
    ...
    str_elem->class = &str_element_class_obj;
